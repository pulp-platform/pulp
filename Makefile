...
pulp-runtime:
	git clone https://github.com/pulp-platform/pulp-runtime.git -b cv32_target
...
test-fast-regressions:
	...
	cd regression_tests && ../pulp-runtime/scripts/bwruntests.py --proc-verbose -v --report-junit -t 7200 --yaml -o simplified-runtime.xml simple-regression-tests.yaml
...
test-local-regressions: 
	...
	source setup/vsim.sh; \
	source pulp-runtime/configs/pulp.sh; \
	cd regression_tests && ../pulp-runtime/scripts/bwruntests.py --proc-verbose -v --report-junit -t 7200 --yaml -o simplified-runtime.xml regression-tests.yaml
...
test-local-runtime: 
	source setup/vsim.sh; \
	source pulp-runtime/configs/pulp.sh; \
	cd tests && ../pulp-runtime/scripts/bwruntests.py --proc-verbose -v --report-junit -t 3600 --yaml -o simplified-runtime.xml runtime-tests.yaml
