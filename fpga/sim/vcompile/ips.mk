...
build:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/cv32e40p.mk build
	...
	@make --no-print-directory -f $(mkfile_path)/ips/udma_hyper.mk build
	...
	@make --no-print-directory -f $(mkfile_path)/ips/hwpe-datamover-example.mk build
...
lib:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/cv32e40p.mk lib
	...
	@make --no-print-directory -f $(mkfile_path)/ips/udma_hyper.mk lib
	...
	@make --no-print-directory -f $(mkfile_path)/ips/hwpe-datamover-example.mk lib
...
clean:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/cv32e40p.mk clean
	...
	@make --no-print-directory -f $(mkfile_path)/ips/udma_hyper.mk clean
	...
	@make --no-print-directory -f $(mkfile_path)/ips/hwpe-datamover-example.mk clean
